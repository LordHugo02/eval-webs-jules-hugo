...
describe('Rooms E2E Tests', () => {
  ...
  it('should get the created room by ID', async () => {
    const response = await axios.get(`${BASE_URL}/api/rooms/${createdRoomId}`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  it('should list rooms (with pagination)', async () => {
    ...
    const response = await axios.get(`${BASE_URL}/api/rooms?skip=0&limit=10`, {
      headers: {
        Authorization: `Bearer ${token}`,
      },
    });
  ...
  it('should verify the room is deleted', async () => {
    try {
      await axios.get(`${BASE_URL}/api/rooms/${createdRoomId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
